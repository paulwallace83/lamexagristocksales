...
## Description
Run by a FRESH agent after implementation and retro are complete. This agent reviews how the new code fits into the broader codebase and whether it sets up future batches for success or creates problems.
...
- Any other issues with Pattern Consistency
...
- Any other issued related to Duplication
...
- Any other issues related to naming conventions
...
- any other issues related to sync survival
...
- any other issues related to test coverage
...
- any other issues related to doc accuracy
